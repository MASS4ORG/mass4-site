---
Title: Turian
Description: The ultimate game engine plugin for Gaya text editor. Create, debug, and deploy games directly from your favorite development environment.
---
...
### Prerequisites
1. **Gaya Text Editor**: Download from [gaya.dev](/gaya)
2. **.NET 6+**: Required for C# game scripting
3. **Platform SDKs**: Optional, for specific platform targeting

## Documentation

- **[Quick Start Guide](/turian/docs/quickstart)** - Get up and running in 10 minutes
- **[API Reference](/turian/docs/api)** - Complete API documentation
- **[Tutorials](/turian/docs/tutorials)** - Step-by-step game creation tutorials
- **[Examples](/turian/examples)** - Sample games and code snippets
- **[Performance Guide](/turian/docs/performance)** - Optimization best practices
...
- 🎮 [Game Showcase](https://showcase.turian.dev) - Games made with Turian
- 💬 [Discord Server](https://discord.gg/turian) - Real-time community support
- 🐛 [Issue Tracker](https://github.mass4org/mass4/turian/issues) - Bug reports and feature requests
- 📚 [Asset Store](https://assets.turian.dev) - Community-created assets and scripts

## License

Turian is released under the MIT License. See [LICENSE](https://mass4org.com/mass4/turian/blob/main/LICENSE) for details.

---

*Turian is part of the [MEGA4 Initiative](/mega4) by [MASS4](/mass4) - four revolutionary tools for modern development.*
