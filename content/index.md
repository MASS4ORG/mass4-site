...
<section class="hero hero-center mass4-hero">
  <div class="wrap">
...
<section class="section" style="padding-top:0">
  <div class="wrap">
    <div class="studio-values">
      ...
      <div class="value reveal">
        <span class="value-icon">◈</span>
        <h4>Honest about stage</h4>
        <p>These are works in progress. Rough edges are shown, not hidden behind a polished roadmap.</p>
      </div>
      <div class="value reveal">
        <span class="value-icon">◈</span>
        <h4>Long bets</h4>
