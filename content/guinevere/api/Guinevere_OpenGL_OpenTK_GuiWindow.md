...
- **Namespace:** [Guinevere.OpenGL.OpenTK](/guinevere/api/namespace-guinevere.opengl.opentk)
- **Source File:** GuiWindow.cs

Represents a GUI window implementation using OpenTK for OpenGL rendering. Provides input handling, window management, and rendering capabilities for the Guinevere GUI framework.
