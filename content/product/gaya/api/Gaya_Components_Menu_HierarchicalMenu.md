...
Hierarchical menu system for Gaya GUI framework

## Properties

### **HasItems**

(*bool*): Gets a value indicating whether the menu has any items

### **Configuration**

(*MenuConfig*): Gets the current menu configuration
