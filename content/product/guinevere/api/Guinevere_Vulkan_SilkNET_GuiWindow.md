...
Represents a GUI window implementation using SilkNET for Vulkan rendering. Provides input handling, window management, and rendering capabilities for the Guinevere GUI framework.
