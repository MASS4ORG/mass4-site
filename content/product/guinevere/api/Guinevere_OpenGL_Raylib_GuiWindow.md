...
- **Namespace:** [Guinevere.OpenGL.Raylib](/guinevere/api/namespace-guinevere.opengl.raylib)
- **Source File:** GuiWindow.cs

Represents a GUI window implementation using Raylib for OpenGL rendering. Provides input handling, window management, and rendering capabilities for the Guinevere GUI framework.
